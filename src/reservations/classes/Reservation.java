...
public class Reservation {
	...
	private Date _timestamp; // date et heure de la dernière mise à jour de la
								// réservation
	...
	private int _status; // 0 = réservation confirmée ; 4 = réservation
							// provisoire
	private String _digicode; // digicode d'accès à la salle pour cette
	 ...
	 * @param unFormat
	 *            : le format de la chaine fournie (ex : "yyyy-MM-dd HH:mm:ss"
	 *            pour format US)
	...
	/** Constructeur */
	public Reservation(int unId, Date unTimeStamp, Date unStartTime, Date unEndTime, String unRoomName, int unStatus,
			String unDigicode) {
		this._id = unId;
