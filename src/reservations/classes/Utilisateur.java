...
public class Utilisateur {
	...
	private int _level; // 0=simple visiteur 1=utilisateur pouvant réserver
						// 2=administrateur
	...
	private ArrayList<Reservation> _lesReservations; // les réservations passées
														// par l'utilisateur
	...
	public void ajouteReservation(Reservation uneReservation) { // ajoute
																// l'objet à la
																// liste
		this._lesReservations.add(uneReservation);
	}

	public Reservation getLaReservation(int i) { // fournit la réservation
													// correspondant à l'index
													// demandé
		return this._lesReservations.get(i);
	}

	public int getNbReservations() { // fournit le nombre de réservations dans
										// la liste
		return this._lesReservations.size();
	}

	public void viderListeReservations() { // vide la collection des
											// réservations
